...
public class Coche extends Vehiculo {
	...
	public Coche(String matricula, String marca, String color, Titular titular, double diametro_delantera, double diametro_trasera, String marca_rueda_delantera, String marca_rueda_trasera) {
